module Solr
  ...
  class Solr
    ...
    FIELDS = [
        { # automatically generated by F4
            name: 'uuid',
            type: 'string',
            stored: true,
            indexed: true
        },
        { # ID (F4 UUID) of the parent item, if present
            name: 'kq_parent_uuid',
            type: 'string',
            stored: true,
            indexed: true
        },
        { # Preserves the order of items in a set
          name: 'kq_page_index',
          type: 'int',
          stored: true,
          indexed: true
        ...
        { # Unique short string identifier of a collection
            name: 'kq_collection_key',
            type: 'string',
            stored: true,
            indexed: true
        },
        { # Short, non-sequential, unique alphanumeric string for use in URLs
            name: 'kq_web_id',
            type: 'string',
            stored: true,
            indexed: true
